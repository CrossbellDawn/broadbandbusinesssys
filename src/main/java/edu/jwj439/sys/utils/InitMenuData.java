...
public class InitMenuData {
    public static void main(String[] args) {
        ...
        menuDao.insert(new Menu(1,0,"汽车租赁系统",null,1,null,"&#xe68e;",1));
        ...
        //业务管理子节点
        menuDao.insert(new Menu(8,3,"汽车出租",null,0,null,"&#xe65b;",1));
        menuDao.insert(new Menu(9,3,"出租单管理",null,0,null,"&#xe6b2;",1));
        menuDao.insert(new Menu(10,3,"汽车入库",null,0,null,"&#xe65a;",1));
        menuDao.insert(new Menu(11,3,"检查单管理",null,0,null,"&#xe705",1));


        //系统管理子节点
        menuDao.insert(new Menu(12,4,"菜单管理",null,0,null,"&#xe60f",1));
        ...
        menuDao.insert(new Menu(16,4,"系统公告",null,0,null,"&#xe645;",1));
