...
<body class="childrenBody">
		...
		<div class="layui-form-item">
			<div class="layui-form-item">
				...
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<input type="text" name="orderBandwidth" autocomplete="off"
							class="layui-input">
					</div>
				</div>
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<input type="text" name="orderCustName" autocomplete="off"
							class="layui-input">
					</div>
				</div>
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<input type="text" name="orderOperator" autocomplete="off"
							class="layui-input">
					</div>
				</div>
			</div>
			<div class="layui-form-item">
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<input type="text" name="orderStarttime" id="startTime"
				...
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<input type="text" name="orderEndtime" id="endTime"
							readonly="readonly" autocomplete="off" class="layui-input">
					</div>
				</div>
				<div class="layui-inline">
	...
	<script type="text/html" id="rentBar">
		...
		<a class="layui-btn layui-btn-xs" style="background-color:#5FB878" lay-event="renew">续费</a>	 
 		{{#  if(d.orderState !=2){ }}
		...
		<form class="layui-form" lay-filter="dataFrm" id="dataFrm">
			...
			<div class="layui-form-item">
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<input type="radio" name="orderFeetype" value="1" title="包年"
							id="orderFeetype" lay-filter="orderFeetype" checked> <input
							type="radio" name="orderFeetype" value="0" title="包月"
							id="orderFeetype" lay-filter="orderFeetype">
					</div>
				</div>
				<div class="layui-inline">
					<label class="layui-form-label">租约费用:</label>
					<div class="layui-input-inline">
						<input type="text" name="orderPay" autocomplete="off"
							class="layui-input">
					</div>
				</div>
			</div>
			<div class="layui-form-item">
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<input type="text" name="orderStarttime" id="orderStarttime"
							autocomplete="off" class="layui-input" lay-verify="timestamp"
									...
									.on(
											...
											function(obj) {
												...
												if (layEvent === 'del') { //删除
													...
													layer.confirm("确定要为【"+data.orderNumber+"】续约吗",function(index){
														$.post("${ctx}/order/updateOrderDate.action",{
															orderId:data.orderId,
